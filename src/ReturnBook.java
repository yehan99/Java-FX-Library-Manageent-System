...
PreparedStatement pst ;
    ...
    public void ReturnUpdate(){
        String sql = "Insert into ReturnBook(StudentID, Name, FName, Course,Branch,Year,Semester,BookID,Name,Edition,Publisher,Price,Pages)values (?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try{
            pst = conn.prepareStatement(sql);
            pst.setString(1, jTextField1.getText());
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null, "Book Returened");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 255, 51)), "Return Book", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(255, 51, 153))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                ...
                String add8 = rs.getString("FatherName");
